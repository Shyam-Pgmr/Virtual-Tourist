...
class VTAPIManager: NSObject {
    ...
    func getImages(forLatitude latitude:Double, longitude:Double, page:Int, completionHandler:@escaping (_ response:AnyObject?,_ error:String?)->Void) -> URLSessionDataTask {
